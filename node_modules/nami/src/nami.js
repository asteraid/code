...
function Nami(amiData) {
    ...
    // выставляем параметры для tls
    if ( typeof(amiData.tlsenable) == 'undefined' )
    	this.amiData.tlsenable = 'no';
...
Nami.prototype.open = function () {
    ...
    if ( this.amiData.tlsenable == 'yes')
    	this.socket = tls.connect({ port: this.amiData.port, 
			   						host: this.amiData.host});	
    else
