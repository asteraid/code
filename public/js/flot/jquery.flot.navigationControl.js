...
; (function ($) {
    ...
    function drawNavigationControl(plot, canvascontext) {
		...
		var home = buttonTemplate.format('zoom-home', '29px', '29px', '⌂', '');
		...
		var zoomout = buttonTemplate.format('zoom-out', '29px', '58px', '-', '');
		...
		$(control).html(zoomin + home + zoomout).appendTo($placeholder);
    ...
    function zoomHome(plot) {
        ...
        var xaxis = axes.xaxis;
        var yaxis = axes.yaxis;
        xaxis.options.min = options.dxaxis.min;//options.navigationControl.homeRange.xmin;
        xaxis.options.max = options.dxaxis.max;//options.navigationControl.homeRange.xmax;
        yaxis.options.min = options.dyaxis.min;//options.navigationControl.homeRange.ymin;
        yaxis.options.max = options.dyaxis.max;;//options.navigationControl.homeRange.ymax;
