  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      ...
                      '<input class="input-mini" type="text" name="daterangepicker_start" value="" style="width: 150px;"/>' +
                    '</div>' +
                    '<div class="daterangepicker_end_input" style="    padding-left: 0px !important;>' +
                      '<label for="daterangepicker_end">To</label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" style="width: 150px;"/>' +
                    '</div>' +
                    '<div class="daterangepicker_exten_input">' +
                      '<label for="daterangepicker_exten">Exten</label>' +
                      '<input type="text" autocomplete="off" name="daterangepicker_exten" autocorrect="off" autocapitalize="off" spellcheck="false" class="select2-input" id="field_ringgroup" tabindex="0" placeholder="" style="width: 150px;">'+
                     '</div>'+
                    '<div class="daterangepicker_context_input">' +
        ...
        this.container.find('.ranges')
            ...
            .on('click.daterangepicker', 'button.remBtn', $.proxy(this.clickRemove, this))
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.container.find('.remBtn').html('Del');

            if (editevent!=null) {

                this.container.find('.remBtn').removeAttr('disabled');
                //debugger;
            } else {
                this.container.find('.remBtn').attr('disabled', 'disabled');
            }
        },
