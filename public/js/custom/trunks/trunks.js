    ...
    if (currentRow.id) {
      $.ajax({
        ...
        success: function(data) {
          ...
          if (list.length > 0)
            //showDialog('Information', '<p align="center">This trunk can\'t be deleted. It included in the following callflows: <strong>' + list + '</strong>', 400, 'auto');
            modal({title: 'Information', body: '<p align="center">This trunk can\'t be deleted. It included in the following callflows: <strong>' + list + '</strong>', width: '400', height: 'auto'});
          else
            //showDialog('Information', '<p align="center">Delete this trunk?</p>', 'auto', 'auto', btnsDelete);
            modal({title: 'Information', body: '<p align="center">Delete this trunk?</p>', width: 'auto', height: 'auto', buttons: btnsDelete});
        }
      });
    }
});